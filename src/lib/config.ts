...
export const PROJECT = {
  ...
  version: '1.0.0',
  license: 'GPL-3.0',
  url: 'https://rocket-game.minidev.app',
  repository: 'https://github.com/MiniDevPlatform/rocket-game',
} as const;
...
export const FEATURES = {
  ...
  // Campaign
  campaign: { enabled: false, levels: [], achievements: [], saveProgress: true, saveKey: 'rocket-game_progress' },
